...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name = "auth/reset_password.html", form_class=EmailValidationOnForgotPassword, html_email_template_name='registration/password_reset_html_email.html'), name ='reset_password'),
