# Generated by Django 3.1.3 on 2020-12-19 20:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(null=True, verbose_name='Məzmun')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.IntegerField(null=True, verbose_name='Cavab Commentin İDsi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picture', models.ImageField(default='profile_images/default.jpg', upload_to='profile_images', verbose_name='Şəkil')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('level', models.IntegerField(default=0)),
                ('roles', models.ManyToManyField(to='student.Role')),
                ('study_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='student.studygroup', verbose_name='Qrup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='comment_images', verbose_name='Commentin şəkli')),
