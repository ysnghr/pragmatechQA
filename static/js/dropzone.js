    ...
    (o = function () {}),
        ...
        ((e = (function (e) {
            ...
            function s(e, t) {
                ...
                if (
                    ...
                    (n = null != (o = s.optionsForElement(this.element)) ? o : {}),
                    (this.options = i({}, this.defaultOptions, n, null != t ? t : {})),
            ...
            return (
                ...
                (s.prototype.defaultOptions = {
                    ...
                    fallback: function () {
                        var e, t, i, n, r, o;
                        for (this.element.className = this.element.className + " dz-browser-not-supported", n = 0, r = (o = this.element.getElementsByTagName("div")).length; n < r; n++)
                            (e = o[n]), /(^| )dz-message($| )/.test(e.className) && ((t = e), (e.className = "dz-message"));
                        return (
                            t || ((t = s.createElement('<div class="dz-message"><span></span></div>')), this.element.appendChild(t)),
                            (i = t.getElementsByTagName("span")[0]) && (i.textContent = this.options.dictFallbackMessage),
                    ...
                    resize: function (e) {
                        var t, i, n;
                        return (
                            (t = { srcX: 0, srcY: 0, srcWidth: e.width, srcHeight: e.height }),
                            (i = e.width / e.height),
                            (t.optWidth = this.options.thumbnailWidth),
                            (t.optHeight = this.options.thumbnailHeight),
                            null == t.optWidth && null == t.optHeight
                                ? ((t.optWidth = t.srcWidth), (t.optHeight = t.srcHeight))
                                : null == t.optWidth
                                ? (t.optWidth = i * t.optHeight)
                                : null == t.optHeight && (t.optHeight = (1 / i) * t.optWidth),
                            (n = t.optWidth / t.optHeight),
                            e.height < t.optHeight || e.width < t.optWidth
                                ? ((t.trgHeight = t.srcHeight), (t.trgWidth = t.srcWidth))
                                : i > n
                                ? ((t.srcHeight = e.height), (t.srcWidth = t.srcHeight * n))
                                : ((t.srcWidth = e.width), (t.srcHeight = t.srcWidth / n)),
                    ...
                    addedfile: function (e) {
                        ...
                        if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                            for (
                                e.previewElement = s.createElement(this.options.previewTemplate.trim()),
                                    e.previewTemplate = e.previewElement,
                                    this.previewsContainer.appendChild(e.previewElement),
                                    n = 0,
                                    l = (p = e.previewElement.querySelectorAll("[data-dz-name]")).length;
                                n < l;
                                n++
                            )
                            ...
                            for (
                                this.options.addRemoveLinks &&
                                    ((e._removeLink = s.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>")), e.previewElement.appendChild(e._removeLink)),
                                    m = this,
                                    t = function (t) {
                                        return (
                                            t.preventDefault(),
                                            ...
                                            e.status === s.UPLOADING
                                                ? s.confirm(m.options.dictCancelUploadConfirmation, function () {
                                                      return m.removeFile(e);
                                                  })
                                                : m.options.dictRemoveFileConfirmation
                                                ? s.confirm(m.options.dictRemoveFileConfirmation, function () {
                                                      return m.removeFile(e);
                                                  })
                                                : m.removeFile(e)
                                        );
                                    ...
                                    h = [],
                                    o = 0,
                                    u = (c = e.previewElement.querySelectorAll("[data-dz-remove]")).length;
                                o < u;
                                o++
                            )
                    ...
                    thumbnail: function (e, t) {
                        var i, n, s, r;
                        if (e.previewElement) {
                            for (e.previewElement.classList.remove("dz-file-preview"), n = 0, s = (r = e.previewElement.querySelectorAll("[data-dz-thumbnail]")).length; n < s; n++) ((i = r[n]).alt = e.name), (i.src = t);
                    ...
                    error: function (e, t) {
                        var i, n, s, r, o;
                        if (e.previewElement) {
                            for (e.previewElement.classList.add("dz-error"), "String" != typeof t && t.error && (t = t.error), o = [], n = 0, s = (r = e.previewElement.querySelectorAll("[data-dz-errormessage]")).length; n < s; n++)
                                (i = r[n]), o.push((i.textContent = t));
                            return o;
                        }
                    },
                    errormultiple: o,
                ...
                (s.prototype.init = function () {
                    ...
                    for (
                        "form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"),
                            ...
                            this.clickableElements.length &&
                                ...
                                (i = function () {
                                    return (
                                        a.hiddenFileInput && document.body.removeChild(a.hiddenFileInput),
                    ...
                    return (
                        ...
                        this.on(
                            ...
                            (function (e) {
                                return function (t) {
                                    if (0 === e.getUploadingFiles().length && 0 === e.getQueuedFiles().length)
                                        return setTimeout(function () {
                ...
                (s.prototype.destroy = function () {
                    ...
                    return (
                        ...
                        (null != (e = this.hiddenFileInput) ? e.parentNode : void 0) && (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), (this.hiddenFileInput = null)),
                    ...
                    return (e = this.getExistingFallback())
                        ...
                        : ((i = '<div class="dz-fallback">'),
                          ...
                          "FORM" !== this.element.tagName
                              ? (n = s.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')).appendChild(t)
                ...
                (s.prototype.setupEventListeners = function () {
                    var e, t, i, n, s, r, o;
                    for (o = [], n = 0, s = (r = this.listeners).length; n < s; n++)
                        (e = r[n]),
                            o.push(
                                (function () {
                                    var n, s;
                ...
                (s.prototype.disable = function () {
                    ...
                    for (
                        ...
                        (e = n[t]), s.push(this.cancelUpload(e));
                    return s;
                }),
                ...
                (s.prototype.filesize = function (e) {
                    var t, i, n, s, r, o, l;
                    for (i = n = null, t = o = 0, l = (r = ["TB", "GB", "MB", "KB", "b"]).length; o < l; t = ++o)
                        if (((s = r[t]), e >= Math.pow(this.options.filesizeBase, 4 - t) / 10)) {
                ...
                (s.prototype._addFilesFromItems = function (e) {
                    var t, i, n, s, r;
                    for (r = [], n = 0, s = e.length; n < s; n++)
                        null != (i = e[n]).webkitGetAsEntry && (t = i.webkitGetAsEntry())
                            ? t.isFile
                                ? r.push(this.addFile(i.getAsFile()))
                                : t.isDirectory
                        ...
                        ((n = document.createElement("img")).onload =
                            ...
                            function () {
                                ...
                                if (
                                    ((e.width = n.width),
                                    (e.height = n.height),
                                    null == (l = s.options.resize.call(s, e)).trgWidth && (l.trgWidth = l.optWidth),
                                    null == l.trgHeight && (l.trgHeight = l.optHeight),
                                    (o = (t = document.createElement("canvas")).getContext("2d")),
                                    (t.width = l.trgWidth),
                ...
                (s.prototype.uploadFiles = function (e) {
                    var t, r, o, l, a, u, p, d, c, h, m, f, g, v, y, F, w, E, b, C, k, z, L, x, T, A, D, S, _, M, U, N, I, R;
                    for (E = new XMLHttpRequest(), b = 0, L = e.length; b < L; b++) (t = e[b]).xhr = E;
                    for (l in ((f = n(this.options.method, e)),
                    (F = n(this.options.url, e)),
                    E.open(f, F, !0),
                    ...
                    (y = (function (i) {
                        return function (n) {
                            ...
                            if (null != n) for (r = (100 * n.loaded) / n.total, o = 0, u = e.length; o < u; o++) (t = e[o]).upload = { progress: r, total: n.total, bytesSent: n.loaded };
                            else {
                                for (s = !0, r = 100, l = 0, p = e.length; l < p; l++)
                                    (100 === (t = e[l]).upload.progress && t.upload.bytesSent === t.upload.total) || (s = !1), (t.upload.progress = r), (t.upload.bytesSent = t.upload.total);
                                if (s) return;
                            }
                    ...
                    (E.onload = (function (t) {
                        return function (i) {
                            ...
                            if (e[0].status !== s.CANCELED && 4 === E.readyState) {
                                if (((v = E.responseText), E.getResponseHeader("content-type") && ~E.getResponseHeader("content-type").indexOf("application/json")))
                                    try {
                                        v = JSON.parse(v);
                                    } catch (e) {
                    ...
                    ((null != (S = E.upload) ? S : E).onprogress = y),
                    (u = { Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest" }),
                    this.options.headers && i(u, this.options.headers),
                    u))
                        (a = u[l]), E.setRequestHeader(l, a);
                    ...
                    if ((this.options.uploadMultiple && this.emit("sendingmultiple", e, E, r), "FORM" === this.element.tagName))
                        for (k = 0, T = (M = this.element.querySelectorAll("input, textarea, select, button")).length; k < T; k++)
                            if (((c = (d = M[k]).getAttribute("name")), (h = d.getAttribute("type")), "SELECT" === d.tagName && d.hasAttribute("multiple")))
                                for (z = 0, A = (U = d.options).length; z < A; z++) (g = U[z]).selected && r.append(c, g.value);
                            else (!h || ("checkbox" !== (N = h.toLowerCase()) && "radio" !== N) || d.checked) && r.append(c, d.value);
        ...
        (e.discover = function () {
            ...
            for (
                ...
                (i = n[s]), !1 !== e.optionsForElement(i) ? o.push(new e(i)) : o.push(void 0);
            return o;
        }),
        ...
        (e.isBrowserSupported = function () {
            ...
            if (((t = !0), window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector))
                if ("classList" in document.createElement("a")) for (i = 0, n = (s = e.blacklistedBrowsers).length; i < n; i++) s[i].test(navigator.userAgent) && (t = !1);
                else t = !1;
            else t = !1;
            return t;
        }),
        ...
        (e.getElements = function (e, t) {
            ...
            } else if ("string" == typeof e) for (n = [], r = 0, l = (a = document.querySelectorAll(e)).length; r < l; r++) (i = a[r]), n.push(i);
        ...
        (e.isValidFile = function (e, t) {
            var i, n, s, r, o;
            if (!t) return !0;
            for (t = t.split(","), i = (n = e.type).replace(/\/.*$/, ""), r = 0, o = t.length; r < o; r++)
                if ("." === (s = (s = t[r]).trim()).charAt(0)) {
        ...
        (s = function (e) {
            var t, i, n, s, r, o, l, a;
            for (e.naturalWidth, r = e.naturalHeight, (t = document.createElement("canvas")).width = 1, t.height = r, (i = t.getContext("2d")).drawImage(e, 0, 0), n = i.getImageData(0, 0, 1, r).data, a = 0, s = r, o = r; o > a; )
                0 === n[4 * (o - 1) + 3] ? (s = o) : (a = o), (o = (s + a) >> 1);
            return 0 === (l = o / r) ? 1 : l;
        }),
